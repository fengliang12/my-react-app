...
import MemberFestivalTab from "../MemberFestivalTab";
...
const Index: React.FC<PropsType> = (props) => {
  ...
  return (
    <>
      <View
        className="w-full h-695 overflow-hidden bg-cover"
        style={{
          backgroundImage: `url(${config.imgBaseUrl}/index/header_bg2.jpg)`,
        }}
      >
        <View
          className="w-690 h-368 m-auto mt-282 bg-cover py-24 px-27 box-border relative"
          style={{
      ...
      {/* 查看会员权益 */}
      <MemberFestivalTab style="padding:0;marginTop: -24rpx;"></MemberFestivalTab>
